...
const Personal = () => {
  ...
  const columns = [
    {
      title: "Nombre",
      field: "nombre",
      filterPlaceholder: "ingrese nombre",
      render: (rowData) => (
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          />
          <p style={{ display: "inline-block", width: "60px" }}>
            {rowData.nombre}
          </p>
        </div>
      ),
  ...
  const enviarPut = async () => {
    ...
    if (true) {
      await axios
        .put(`/personal/update/${getData.id}`, data)
        .then((res) => {
                ...
                actions={[
                  ...
                  },
                  {
                    ...
                    onClick: async (event, rowData) => {
                      ...
                      await setGetData(() => ({
                        ...
                        correo: rowData.correo === null ? "" : rowData.correo,
                        idTipoPersonal: rowData.idTipoPersonal,
                      }));
                      await setCargo(rowData.idTipoPersonal);
                    },
                  },
                  {
                    ...
                    onClick: async (event, rowData) => {
                      await axios
                        .delete(`/personal/delete/${rowData.id}`)
                        .then((res) => {
                          setRespuesta(res.data);
                        })
                        .catch((err) => {
                  ...
                  },
                  {
                    ...
                    onClick: (event, rowData) =>
                      (window.location.href = "/registrar%20personal"),
                    isFreeAction: true,
                  },
                  {
                    icon: () => (
      ...
      >
        ...
        <div className="conternedor_formulario">
          ...
          <TextField
            ...
            label="cargo"
            select
            value={getData.idTipoPersonal}
            required
            style={{ width: "49%" }}
            helperText=""
            onChange={(e) => setGetData({ ...getData, idTipoPersonal: e.target.value })}
            name="idTipoPersonal"
          >
